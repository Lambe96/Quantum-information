module ex10module
  ...
  contains
    ...
    subroutine sigma_z_i(N,ii,mat_prod)
      complex(kind=8), dimension(:,:), allocatable :: prod_id, prod_1, prov_prod, mat_prod
    ...
    !!!!!!!!!!!!!!!!!!! compute sigma_x^(i) !!!!!!!!!!!!!!!!!!!
    subroutine sigma_x_i(N,ii,mat_prod)
      complex(kind=8), dimension(:,:), allocatable :: prod_id, prod_1, prov_prod, mat_prod
      complex(kind=8), dimension(2,2) :: sigma_x, identity
      integer :: N, ii,jj
      ...
      if ( ii .eq. 1) then
        call tensor_product(sigma_x,prod_id,prov_prod)
        deallocate(prod_id)
        prod_id = prov_prod
        deallocate(prov_prod)
      else
        call tensor_product(prod_id,sigma_x,prov_prod)
        deallocate(prod_id)
        prod_id = prov_prod
        deallocate(prov_prod)
      end if
    ...
    end subroutine sigma_x_i
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    !!!!!!!!!!!!!!!!!!! compute sigma_x^(i+1)sigma_x^(i) !!!!!!!!!!!!!!!!!!!
    subroutine sigma_xx_i(N,ii,mat_prod)
      complex(kind=8), dimension(:,:), allocatable :: prod_id, prod_1, prov_prod, mat_prod
      complex(kind=8), dimension(2,2) :: sigma_x, identity
      integer :: N, ii,jj
      ...
      if ( ii .eq. 1) then
        call tensor_product(sigma_x,sigma_x,prov_prod)
        deallocate(prod_id)
        prod_id = prov_prod
        deallocate(prov_prod)
      else
    ...
    subroutine H_ising_np_tr(N,lambda,ham)
      complex(kind=8), dimension(:,:), allocatable :: mat_prod,int_term,ham, mat_prod_1,mat_prod_2,tr_term
      real(kind=8) :: lambda
      integer :: N, ii,jj
...
!compile with 'gfortran -c ex10_module.f90'

end  module ex10module
